...
function accredible_get_templates() {
	...
	$curl = curl_init('https://sandbox.api.accredible.com/v1/issuer/templates');
...
function accredible_update_certificate_grade($certificate_id, $evidence_item_id, $grade) {
  global $CFG;
	...
	$curl = curl_init('https://sandbox.api.accredible.com/v1/credentials/' . $certificate_id . '/evidence_items/'.$evidence_item_id);
...
function accredible_post_evidence($credential_id, $evidence_item, $allow_exceptions) {
	...
	$curl = curl_init('https://sandbox.api.accredible.com/v1/credentials/' . $credential_id . '/evidence_items');
